...
>(
  (
    ...
    const toggleOption = (option: string) => {
      const newSelectedValues = Array.isArray(value) && value.includes(option)
        ? value.filter((val) => val !== option)
        : Array.isArray(value) ? [...value, option] : [option];
    ...
    const clearExtraOptions = () => {
      const newSelectedValues = Array.isArray(value) ? value.slice(0, maxCount) : [];
      onValueChange(newSelectedValues);
    };
