// hooks\api\dashboard\organizer\useFetchOrganizerEventsData.ts
...
export const useFetchOrganizerEventsData = () => {
    ...
    const fetchEvents = useCallback(async () => {
        ...
        try {
            ...
            const eventsData: OrganizerEvent[] = Array.isArray(response.data)
