// app\(logged)\dashboard\(nationalFederation)\jury\components\NationalJuryEventsTableControls.tsx
// app/(logged)/dashboard/(nationalFederation)/jury/components/NationalJuryEventsTableControls.tsx
'use client';
...
interface NationalJuryEventsTableControlsProps<TData> {
...
export function NationalJuryEventsTableControls<TData>({ table }: NationalJuryEventsTableControlsProps<TData>) {
  return (
