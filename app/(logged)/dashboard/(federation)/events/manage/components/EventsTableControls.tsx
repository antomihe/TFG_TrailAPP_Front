// app\(logged)\dashboard\(federation)\events\manage\components\EventsTableControls.tsx
...
interface ManagerEventsTableControlsProps<TData> {
...
export function ManagerEventsTableControls<TData>({ table }: ManagerEventsTableControlsProps<TData>) {
  return (
