// app\(logged)\dashboard\(organizer)\events\equipment\components\OrganizerEquipmentEventsTableColumns.tsx
import { ColumnDef } from "@tanstack/react-table";
import { Button } from '@/components/ui/button';
import { Badge } from "@/components/ui/badge";
import { ArrowUpDown, ArrowUp, ArrowDown, CalendarDays, MapPin, Building, PackagePlus, ListChecks } from 'lucide-react'; // Added icons
import { dateFormatter, normalizeString, customDateSort } from '@/lib/utils';
import { OrganizerEquipmentEventActionCell } from './OrganizerEquipmentEventActionCell';
...
export const getOrganizerEquipmentEventsTableColumns = (): ColumnDef<OrganizerEquipmentEvent>[] => [
  {
    accessorKey: "name",
  ...
  },
  {
    ...
    enableHiding: false,
    enableSorting: false,
    cell: ({ row }) => <OrganizerEquipmentEventActionCell row={row} />,
    meta: {
      headerClassName: "w-[120px] text-center",
      cellClassName: "text-center",
    }
