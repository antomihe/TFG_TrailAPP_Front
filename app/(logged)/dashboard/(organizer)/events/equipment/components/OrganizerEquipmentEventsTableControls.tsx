// app\(logged)\dashboard\(organizer)\events\equipment\components\OrganizerEquipmentEventsTableControls.tsx
// app/(logged)/dashboard/(organizer)/events/equipment/components/OrganizerEquipmentEventsTableControls.tsx
'use client';
...
interface OrganizerEquipmentEventsTableControlsProps<TData> {
...
export function OrganizerEquipmentEventsTableControls<TData>({
  table,
  filterValue,
  onFilterChange
}: OrganizerEquipmentEventsTableControlsProps<TData>) {
  return (
